...
@Component
public class PointsPaymentStrategy extends BasePaymentStrategy {

    protected PointsPaymentStrategy(PaymentRepository paymentRepository,
    ...
    public PaymentMethodType getPaymentMethod() {
        return PaymentMethodType.POINTS;
    }
}
