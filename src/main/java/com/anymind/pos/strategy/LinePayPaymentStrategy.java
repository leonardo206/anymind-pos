...
@Component
public class LinePayPaymentStrategy extends BasePaymentStrategy {

    protected LinePayPaymentStrategy(PaymentRepository paymentRepository,
    ...
    public PaymentMethodType getPaymentMethod() {
        return PaymentMethodType.LINE_PAY;
    }
}
