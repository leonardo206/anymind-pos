...
@Component
public class GrabPayPaymentStrategy extends BasePaymentStrategy {

    protected GrabPayPaymentStrategy(PaymentRepository paymentRepository,
    ...
    public PaymentMethodType getPaymentMethod() {
        return PaymentMethodType.GRAB_PAY;
    }
}
