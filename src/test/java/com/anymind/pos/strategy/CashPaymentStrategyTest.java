...
class CashPaymentStrategyTest {
    ...
    @BeforeEach
    void setUp() {
        when(paymentMethodRepository.findByPaymentMethodType(PaymentMethodType.CASH))
        ...
        cashPaymentStrategy.initializeModifiers();
    }
    ...
    void testProcessPaymentSuccess() {
        ...
        PaymentResponseDTO response = cashPaymentStrategy.processPayment(request);
    ...
    void testPriceModifierOutOfBounds() {
        ...
        InvalidPaymentRequestException exception = assertThrows(InvalidPaymentRequestException.class, () -> {
            cashPaymentStrategy.processPayment(request);
        });
